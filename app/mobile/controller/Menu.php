...
use app\mobile\model\MobileMenu as MobileMenuModel;
use app\mobile\validate\MenuValidate;
...
class Menu extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->model = new MobileMenuModel();
    }
    ...
    public function datalist()
    {
        if (request()->isAjax()) {
			...
			foreach ($list as $key => &$val) {
				$val['types_title'] = Db::name('MobileTypes')->where(['id' => $val['types']])->value('title');
			}				
